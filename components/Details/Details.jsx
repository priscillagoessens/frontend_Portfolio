...
export default function Details({sectionStyle, titleStyle, contentStyle, iconContainerStyle, iconGit, linkedin}) {
    return (
      <div className={sectionStyle} id="description">
        ...
        Avec une expertise solide en <strong>HTML</strong>, <strong>CSS</strong>, <strong>Sass</strong>, et <strong>JavaScript</strong>, je conçois des interfaces intuitives et attrayantes. J'exploite des technologies modernes comme React.js et Next.js pour développer des applications web performantes, évolutives, et adaptées aux besoins actuels.<br/>
        Mon expérience avec <strong></strong>WordPress et <strong></strong>WooCommerce m'a permis de réaliser des solutions personnalisées, optimisées pour des sites e-commerce réussis.<br/><br/>
